...
def crear_bd():
	...
	# Probamos a crear la primera tabla
	try:
		...
		print("Tabla de Categorías creada correctamente.")

	# Probamos a crear la segunda tabla
	try:
		...
		print("Tabla de Platos creada correctamente.")
...
def mostrar_menu():
	...
	for categoria in categorias:
		print(categoria[1])	
		# Consultamos de cada categoría los platos
